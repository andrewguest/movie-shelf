...
<div>
    <div class="p-6">
        ...
        <div id="sort-and-filter-grid" class="grid grid-cols-8 gap-6">
            ...
            <form onsubmit="return false;" class="space-y-6 mb-10">
                <div class="space-y-1">
                    ...
                    <select
                        ...
                        on:change={filterAllMoviesByReleaseYear(
            ...
            <form onsubmit="return false;" class="space-y-6 mb-10">
                <div class="space-y-1">
                    <label class="font-medium" for="sort_by_select"
                        >Sort movies by</label
                    >
                    <select
                        class="w-full block border bg-white border-gray-200 rounded px-3 py-2 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                        id="sort_by_select"
                    ...
                    >
                        ...
                        <option value="release_year_asc"
                            >Release Year (Ascending)</option
                        >
                        <option value="release_year_desc"
                            >Release Year (Descending)</option
                        >
                    </select>
                </div>
            </form>
            ...
            <button
                ...
                ><svg
                    ...
                    /></svg
                >Import from CSV<span class="block text-xs">Max size: 50MB</span
                ></button
            >
            <!-- END import button -->
        </div>
            ...
            {#each movies_data as movie}
                ...
                >
                    <div class="p-5 lg:p-6 grow w-full text-center">
                        <div
                            class="rounded-md -mx-2.5 -mt-2.5 mb-5 overflow-hidden"
                        >
                            <a
                        ...
                        <h3 class="flex items-center my-2 mb-4">
                            <span
                                aria-hidden="true"
                                class="grow bg-gray-300 rounded h-0.5"
                            />
                        </h3>
